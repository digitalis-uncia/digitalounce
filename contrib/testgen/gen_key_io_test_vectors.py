...
bech32_templates = [
  ...
  ('doz',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('doz',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('doz',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('doz',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tdoz',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tdoz',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tdoz',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tdoz',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tdoz',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tdoz',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tdoz',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tdoz',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rdoz',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rdoz',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rdoz',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rdoz', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tdoz',   17, 32, Encoding.BECH32M, False, False, False),
  ('rdoz',  3,  1, Encoding.BECH32M, False, False, False),
  ('doz',   15, 41, Encoding.BECH32M, False, False, False),
  ('tdoz',    0, 16, Encoding.BECH32,  False, False, False),
  ('rdoz',  0, 32, Encoding.BECH32,  True,  False, False),
  ('doz',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tdoz',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rdoz',  0, 20, Encoding.BECH32,  False, False, True),
  ('doz',    0, 20, Encoding.BECH32M, False, False, False),
  ('tdoz',    0, 32, Encoding.BECH32M, False, False, False),
  ('rdoz',  0, 20, Encoding.BECH32M, False, False, False),
  ('doz',    1, 32, Encoding.BECH32,  False, False, False),
  ('tdoz',    2, 16, Encoding.BECH32,  False, False, False),
  ('rdoz', 16, 20, Encoding.BECH32,  False, False, False),
]

Contributing to Digitalounce Core
============================

The Digitalounce Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Digitalounce Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/digitalounce-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to digitalounce-qt
...
The following applies to code changes to the Digitalounce Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Digitalounce
Network Protocol consensus changes.

Whether a pull request is merged into Digitalounce Core rests with the project merge
...
Patches that change Digitalounce consensus rules are considerably more involved than
...
Where a patch set proposes to change the Digitalounce consensus, it must have been
...
The project leader is the release manager for each Digitalounce Core release.

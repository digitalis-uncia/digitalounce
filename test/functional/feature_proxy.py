...
"""Test digitalounced with different proxy configuration.

Test plan:
- Start digitalounced's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on digitalounced side:

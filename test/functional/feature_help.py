...
"""Verify that starting digitalounce with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start digitalounce with -h for help text")
        ...
        self.log.info("Start digitalounce with -version for version information")
        ...
        self.log.info("Start digitalounced with -fakearg to make sure it does not start")

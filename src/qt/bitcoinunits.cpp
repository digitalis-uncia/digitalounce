...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("DOZ");
    case mBTC: return QString("grams");
    case uBTC: return QString("grains");
    case SAT: return QString("ozoshi");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Digitalounces");

// Copyright(C) 2011 - 2020 The Digitalounce Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef DIGITALOUNCE_MWEB_MODELS_H
#define DIGITALOUNCE_MWEB_MODELS_H
...
#endif // DIGITALOUNCE_MWEB_MODELS_H
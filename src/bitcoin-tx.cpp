...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " digitalounce-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  digitalounce-tx [options] <hex-tx> [commands]  Update hex-encoded digitalounce transaction\n" +
            "or:     digitalounce-tx [options] -create [commands]   Create hex-encoded digitalounce transaction\n" +
            "\n";

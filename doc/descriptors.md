# Support for Output Descriptors in Digitalounce Core

Since Digitalounce Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `doz1...` for mainnet or `tdoz1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Digitalounce Core wallets, a convenience function `combo` is

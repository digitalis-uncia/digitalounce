...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/digitalounce-project/digitalounce/blob/0.13/src/chainparams.cpp#L214).
